package cn.variZoo.Configuration.File;

import cn.variZoo.Configuration.Form.Comments;
import cn.variZoo.Configuration.Form.ConfigurationFile;
import cn.variZoo.Configuration.Form.ConfigurationPart;
...
public class Config extends ConfigurationFile {
    ...
    public static class AnimalSpawn extends ConfigurationPart {
        ...
        public static class Basic extends ConfigurationPart {
            ...
            @Comments(cn_value = {"动物生成时附带体型大小的概率", "设置为0或者负数禁用, 最大为100"},
            ...
            @Comments(cn_value = {"体型变化值", "degree可填写范围或者多个数字"},
        ...
        public static class Mutant extends ConfigurationPart {
            ...
            @Comments(cn_value = {"变化值", "degree可填写范围或者多个数字"},
        ...
        public static class BlackList extends ConfigurationPart {
            ...
            @Comments(cn_value = {"不受影响的动物", "https://hub.spigotmc.org/javadocs/spigot/org/bukkit/entity/EntityType.html"},
    ...
    public static class Breed extends ConfigurationPart {
        ...
        @Comments(cn_value = "动物生育宝宝是否遗传体型",
        ...
        @Comments(cn_value = "多胞胎功能",
                value = "Multiple Birth")
        public static Multiple multiple = new Multiple();
        @Comments(cn_value = {"黑名单", "给予玩家varizoo.skip.breed权限可以单独关闭遗传功能, 防止一些生物牧场被破坏"},
        ...
        public static class Inheritance extends ConfigurationPart {
            ...
            @Comments(cn_value = {"父母对孩子体型的影响", "可使用复杂的公式, 留空时禁用", "可用变量：{father}、{mother}父母的体型, {degree}对应下方比例"},
            ...
            @Comments(cn_value = "比例, 配合前一个final-scale使用",
                    value = "Used in conjunction with the previous 'final-scale'")
            public String degree = "2.1-2.5";

            @Comments(cn_value = "开启该选项会让宝宝不受animal-spawn的二次体型变化影响",
            ...
            @Comments(cn_value = {"当饲养出宝宝时的提示", "仅支持minimessage颜色格式, 留空时禁用", "可用变量: {scale}体型, {baby}宝宝名称, {player}玩家名称"},
    ...
    public static class Other extends ConfigurationPart {
        ...
        @Comments(cn_value = {"美西螈和鱼装进桶后放出会失去原有的体型", "该功能可以保留体型, 会修正鱼桶和发射器"},
        ...
        @Comments(cn_value = {"使动物的掉落物数量乘以以下值", "可使用复杂的公式, 留空时禁用", "可用变量：{scale}生物体型"},
