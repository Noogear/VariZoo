...
public class Configuration extends ConfigurationFile {
    ...
    public static class Breed extends ConfigurationPart {
        ...
        @Comment(cn_value = "动物生育宝宝是否遗传体型",value = "Whether animals' babies inherit the body size when giving birth" )
        public static Inheritance inheritance = new Inheritance();
        @Comment(cn_value = "多胞胎功能",value = "Multiple Birth")
        ...
        public static class Inheritance extends ConfigurationPart {
            ...
            @Comment(cn_value = "比例, 配合上方的final-scale使用")
        ...
        public static class Multiple extends ConfigurationPart {
            ...
            @Comment(cn_value = {"每次生孩子的间隔", "单位为tick, 20ticks = 1s"}, value = {"The interval between each childbirth", "The unit is ticks, 20 ticks = 1 second"})
            public int delay = 3;
    ...
    public static class Other extends ConfigurationPart {
        ...
        @Comment(cn_value = "蝾螈、鱼等动物装进桶后放出会失去原有的体型, 该功能可以保留体型, 会修正鱼桶和发射器")
